...
| :--- | :--- | :--- |
| **The Sovereign Curator (Breaking the 1-Song / 1-Playlist Cage):**<br/>*"Streaming platforms trap you in a 1-song / 1-playlist cage—no multi-select, no simultaneous side-by-side list comparisons, no set math, and zero format freedom."* | **The Genesis & Crown Jewel of Playlist Haven (True Organizational Sovereignty):**<br/>• **Multi-Pane Workspace**: Inspect and manipulate 1, 2, or 4 playlists side-by-side simultaneously.<br/>• **Deep Batch Actions**: Multi-select, Range Select (Song A → B), Invert Selection, bulk move (Top/Bottom), and drag-and-drop between panes.<br/>• **Targeted Conditional Filters**: Filter panes on the fly by Artist, Album, or Play Count.<br/>• **Mathematical Set Operations**: Execute true Union ($A \cup B$), Intersection ($A \cap B$), and Difference ($A - B$) between lists.<br/>• **Fuzzy Cross-Pruning**: Automatically detect and purge cross-playlist duplicates with adjustable similarity sliders.<br/>• **Universal Format Agility**: Instant bidirectional conversion between `.m3u` and `.csv` with auto-synthesized metadata headers for DJ decks and streaming. | **4. Playlist Manipulator (Single, Dual & Quad 4-Pane)** |
| **The Sovereign Purifier (Pure Discovery & Spiced Flow):**<br/>*"I want to audition a 200-song discovery batch without wasting ear-time on tracks I already know, while avoiding back-to-back artist clusters."* | • **Anti-Repeat Purity Guard**: Aggressively subtracts your past listening history and local offline music library via fuzzy cross-matching, guaranteeing 100% unencountered discovery.<br/>• **Artist Separation Spacing**: Applies cryptographic shuffle to prevent back-to-back artist clustering, ensuring diverse and well-paced exploration queues. | **8. Playlist Matcher / Reconciler & 10. Playlist Randomizer** |
| **The DJ & Live Selector (Zero-Typing Digitization):**<br/>*"I took a photo of a festival lineup, a DJ booth tracklist, or a screenshot of an unreleased set."* | Instantly digitizes flyer images and screenshots into clean, playable `.m3u` and `.csv` files via Cloud Gemini 2.5 Flash or 100% offline local vision models (Ollama / LM Studio)—no manual retyping. | **11. Vision-to-Playlist AI** |
